...
{
    mMotorL1 = new ctre::phoenix::motorcontrol::can::WPI_VictorSPX{DriveTrainConstants::Mecanum::kMotorL1Id};
    mMotorL2 = new ctre::phoenix::motorcontrol::can::WPI_TalonSRX{DriveTrainConstants::Mecanum::kMotorL2Id};
    mMotorR1 = new ctre::phoenix::motorcontrol::can::WPI_VictorSPX{DriveTrainConstants::Mecanum::kMotorR1Id};
    mMotorR2 = new ctre::phoenix::motorcontrol::can::WPI_VictorSPX{DriveTrainConstants::Mecanum::kMotorR2Id};
