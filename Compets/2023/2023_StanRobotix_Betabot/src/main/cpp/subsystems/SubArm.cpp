...
void SubArm::Init()
{
    ...
    //        .WithWidget("Number Slider")
    //        .GetEntry();
    mArmTab.AddDouble("Current Position", [this]{return CurrentPosition();})
           .WithWidget("Number Bar");
    mArmTab.AddDouble("Current Speed", [this]{return CurrentSpeed();})
           .WithWidget("Number Bar");
}
...
{
    return mMotorArmEncoder.GetVelocity();
}